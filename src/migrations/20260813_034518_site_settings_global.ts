...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "site_settings" (
  	...
  	"site_name" varchar DEFAULT '无锡云码智创科技' NOT NULL,
  	...
  	"default_s_e_o_title" varchar DEFAULT '无锡云码智创科技｜软件定制、网站开发、APP开发、小程序开发、AI应用开发、Web3开发、项目二次开发' NOT NULL,
  	"default_s_e_o_description" varchar DEFAULT '无锡云码智创科技提供软件定制开发、网站开发、APP开发、小程序开发、AI应用开发、Web3区块链智能合约开发、项目二次开发，覆盖IoT物联网、能源管理、企业管理、电商、医疗、Web3、金融等数字化场景。' NOT NULL,
