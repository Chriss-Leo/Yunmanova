...
export const faqs = [
  ...
  {
    question: '支持哪些技术栈，如何为项目选择技术方案？',
    answer:
      '技术能力覆盖前端、后端、移动端、数据库与云端运维，包括 React、Vue、Java、Go、Python、Node.js、Flutter、Uniapp、PostgreSQL、Redis、Docker 和 Kubernetes 等。实际项目不会为了堆叠技术而固定套用某套组合，而是根据业务目标、系统复杂度、团队协作、部署环境与长期维护要求进行选型。',
  },
  {
  ...
  {
    question: '有哪些研发、项目交付和持续服务经验？',
    answer:
      '目前已积累 10 年以上研发经验，完成 50+ 项目交付，服务场景覆盖 20+ 行业领域，并提供 7×24 技术支持。合作过程中会通过清晰的阶段目标、可见成果和持续响应，让技术能力与服务质量可以被实际验证。',
  },
]
