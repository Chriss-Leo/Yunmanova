...
export const generateMetadata = () =>
  generateSiteMetadata({
    ...
    description:
      '无锡云码智创科技为中国企业提供软件定制、网站开发、APP开发、小程序开发、AI应用开发、Web3区块链智能合约开发、项目二次开发，覆盖IoT物联网、能源管理、企业管理、电商、医疗、Web3和金融平台。',
    canonical: '/',
  })
    ...
    <main className="marketing-page reference-home">
      <JsonLd
        data={[
          ...
          buildPageJsonLd({
            description:
              '无锡云码智创科技为中国企业提供软件定制、网站开发、APP开发、小程序开发、AI应用开发、Web3区块链智能合约开发、项目二次开发。',
            name: '无锡云码智创科技首页',
            path: '/',
            settings,
          }),
